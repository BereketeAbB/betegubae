[
      {
        title: "ውዳሴ ማርያም ዘሰኑይ",
        audioSrc: "./01-WedaseMar_Monday.mp3",
        lyricsTimestamp: [
          {
            key: "ዘሠኑይ",
            data: [
              { time: 1.14, end: 1.18,  text: "(ፈ)[፴](ቀ)[^](ደ)" },
              { time: 1.17, end: 1.28,  text: "እግ(ዚ)[,](እ)[ረዩ]" },
              { time: 1.28, end: 1.34,  text: "(ያ)[V]ግ(ዕ)[:](ዞ)[ምን]" },
              { time: 1.34, end: 1.39,  text: "(ለ)[,^]አ(ዳ)[,](ም)[ቀ]" },
              { time: 1.39, end: 1.47,  text: "(ኅ)[V]ዙ(ነ)[.] ወትኩዘ (ልብ)[ረዩ]" },
              { time: 1.46, end: 1.50,  text: "ወያግ(ብ)[.](ኦ)[ለኪ]" },
              { time: 1.50, end: 1.54,  text: "ኀበ (ዘ)[V]ት(ካ)[,^]ት" },
              { time: 1.54, end: 1.58,  text: "መን(በ)[፴](ሩ)[ሮን]" },
              { time: 1.54, end: 2.02, text: "ሰ(አሊ)[ነኪ] ለ(ነ)[.] ቅድ(ስት)[ር]።" }
            ]
          },
      ...
      {
        title: "ውዳሴ ማርያም ዘሰኑይ",
        audioSrc: "./02-WedaseMar_Tuesday.mp3",
        lyricsTimestamp: [
        {
            key: "ለሔዋን",
            data: [
              { time: 2.10, end: 2.15, text: "ሠ(ረ)[,](ቀ)[ቀ] በ(ሥ)[V](ጋ)[ሠም]" },
              { time: 2.15, end: 2.20, text: "(እ)[፴]ምድን(ግ)[:](ል)[ጎል]" },
              { time: 2.20, end: 2.25, text: "ዘእን(በለ)[ነኪ] (ዘ)[V]ር(ዐ)[፴] ብእ(ሲ)[ሔ]" },
              { time: 2.25, end: 2.30, text: "ወአድ(ኀ)[V]ነ(ነ)[ር]" },
              { time: 2.25, end: 2.30, text: "ለ(ሔ)[,](ዋ)[,](ን)[ረዩ]" },
              { time: 2.25, end: 2.30, text: "እንተ አስሐ(ታ)[ሰአ] (ከ)[,^]ይ(ሲ)[ኃኒ]" },
              { time: 2.25, end: 2.30, text: "(ፈ)[~]ት(ሐ)[፴] ላዕ(ሌሃ)[ኃኒ]" },
              { time: 2.25, end: 2.30, text: "እግዚአ(ብ)[V](ሔ)[.]ር እንዘ ይ(ብል)[ሠም]" },
              { time: 2.25, end: 2.30, text: "(ብዙ)[ሰአ]ኀ አ(በ)[,^]ዝ(ኆ)[ኃኒ] ለሕ(ማ)[V]ም(ኪ)[ር]" },
              { time: 2.25, end: 2.30, text: "ወለ(ፃ)[,]ዕ(ር)[,](ኪ)[ዚእ]" },
              { time: 2.25, end: 2.30, text: "(ሠ)[ነኪ]ምረ (ልቡ)[ሠም]" },
              { time: 2.25, end: 2.30, text: "ኀበ ፍቅረ (ሰ)[.](ብእ)[ትስ]" },
              { time: 2.25, end: 2.30, text: "ወአ(ግዐ)[፴](ዛ)[ሮን]" },
              { time: 1.54, end: 2.02, text: "ሰ(አሊ)[ነኪ] ለ(ነ)[.] ቅድ(ስት)[ር]።" },
            ]
          }
        ],
        translationData: [
          {
            ...
            data: [
              {
                reading: {
                  am: "የሁለተኛው ገጽ የመጀመሪያ ክፍል ትርጉም",
                  en: "Translation for the first part of page 2",
                  gz: "የሁለተኛው ገጽ የመጀመሪያ ክፍል ትርጉም በግዕዝ"
                },
                commentaries: [
                  {
                    reading: {
                      am: "የሁለተኛው ገጽ የመጀመሪያ ክፍል አንድምታ",
      ...
      {
        title: "ውዳሴ ማርያም ዘሰኑይ",
        audioSrc: "./03-WedaseMar_Wednesday.mp3",
        lyricsTimestamp: [
                    {
            key: "ኢየሱስ",
            data: [
              { time: 2.10, end: 2.15, text: "ኢ(የ)[ዓይ](ሱ)[^](ስ)[ንቲ] ክርስ(ቶስ)[ውእ]" },
              { time: 2.15, end: 2.20, text: "(ቃ)[:]ል ዘተ(ሰ)[,]ብ(ቀ)[ቀ]" },
              { time: 2.20, end: 2.25, text: "ወ(ኀ)[V]ደ(ረ)[.] ላዕ(ሌነ)[ሠም]" },
              { time: 2.25, end: 2.30, text: "ወር(ኢ)[ሰአ]ነ ስብ(ሐ)[,^]ቲ(ሁ)[ዕኒ]" },
              { time: 2.25, end: 2.30, text: "(ከ)[V]መ ስብ(ሐ)[፴]ተ (አ)[V]ሐእ(ዱ)[,,^]" },
              { time: 2.25, end: 2.30, text: "(ዋ)[V]ሕ(ድ)[፴]" },
              { time: 2.25, end: 2.30, text: "ለአ(ቡ)[.](ሁ)[ዚእ]" },
              { time: 2.25, end: 2.30, text: "(ሠ)[~](ምረ)[ረዩ] ይሠ(ሃለ)[፴](ነ)[ሮን]" },
              { time: 1.54, end: 2.02, text: "ሰ(አሊ)[ነኪ] ለ(ነ)[.] ቅድ(ስት)[ር]።" },
            ]
          },
        ],
        ...
        lyricsTimestamp: [
    {
            key: "ርእየ",
            data: [
              { time: 2.10, end: 2.15, text: "(ርእ)[ኮን](የ)[ኪ]" },
              { time: 2.15, end: 2.20, text: "ኢ(ሳይ)[ፔር](ይ)[፴](ያ)[V]ስ ነ(ቢ)[.](ይ)[ለኪ]" },
              { time: 2.20, end: 2.25, text: "(በ)[~](መ)[ወቀ]ንፈሰ (ት)[፴]ን(ቢ)[,](ት)[ቀ]" },
              { time: 2.25, end: 2.30, text: "ምስ(ጢ)[V]ሮ ለዐማኑ(ኤል)[ሠም]" },
              { time: 2.25, end: 2.30, text: "ወበእን(ተዝ)[ሰአ] ጸር(ሐ)[ዲ]" },
              { time: 2.25, end: 2.30, text: "(ጸ)[.]ር(ሐ)[ዲ]" },
              { time: 2.25, end: 2.30, text: "(እ)[፥]ንዘ (ይ)[](ብል)[ዚእ]" },
            ]
          },
        ],
        translationData: [
        ...
        lyricsTimestamp: [
          {
            ...
            data: [
              ...
              { time: 6.13, end: 6.20, text: "(ኦ)[~] ዘመደ ዕጓለ እመ ሕያው" },
              { time: 6.21, end: 6.27, text: "እስመ አፍቀ(ሮ)[ሰአ] እግዚ(አ)[,^]ብ(ሔ)[•](ር)[ዴ]" },
              { time: 6.27, end: 6.36, text: "ለዓለም" },
              { time: 6.36, end: 6.44, text: "ወመጠወ" },
              { time: 6.44, end: 6.49, text: "ወልዶ ዋሕደ" },
              { time: 6.49, end: 6.54, text: "ከመ ይሕየው ኲሉ" },

              { time: 6.49, end: 6.59, text: "ዘየአምን ቦቱ እስከ ለዓለም" },
              { time: 7.00, end: 7.08, text: "ፈነወ ለነ" },
              { time: 7.08, end: 7.16, text: "መዝራዕቶ ልዑለ" },
              { time: 7.17, end: 7.20, text: "ሰ(አሊ)[ነኮ] ለ(ነ)[.] ቅድ(ስት)[ር]።" }
            ]
          },
          {
            key: "ኀለፈ ክረምት",
